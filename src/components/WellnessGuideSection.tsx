    ...
    <section className="container mx-auto px-6 py-12">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="text-lg text-sage-600 leading-relaxed max-w-4xl mx-auto space-y-4">
            <p>
        ...
        <div className="mb-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <div className="text-sage-700">1. Cabeza (Estrés y sueño)</div>
            <div className="text-sage-700">2. Pulmones</div>
            <div className="text-sage-700">3. Riñones</div>
            <div className="text-sage-700">4. Sistema digestivo (estómago, cólon e intestinos)</div>
            <div className="text-sage-700">5. Hígado</div>
            <div className="text-sage-700">6. Presión arterial y colesterol (Corazón)</div>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-12">
          <div className="relative">
            ...
            {/* Áreas clickeables - posicionadas sobre la imagen */}
            {/* Cerebro */}
            <button
              onClick={() => handleBodyPartClick('head')}
              className="absolute w-16 h-16 bg-sage-600/20 hover:bg-sage-600/40 rounded-full border-2 border-sage-600 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="absolute w-20 h-16 bg-sage-600/20 hover:bg-sage-600/40 rounded-lg border-2 border-sage-600 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="absolute w-12 h-12 bg-sage-600/20 hover:bg-sage-600/40 rounded-full border-2 border-sage-600 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="absolute w-16 h-12 bg-sage-600/20 hover:bg-sage-600/40 rounded-lg border-2 border-sage-600 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="absolute w-18 h-20 bg-sage-600/20 hover:bg-sage-600/40 rounded-lg border-2 border-sage-600 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="absolute w-14 h-16 bg-sage-600/20 hover:bg-sage-600/40 rounded-lg border-2 border-sage-600 transition-all duration-200 hover:scale-110"
              style={{ top: '48%', left: '8%' }}
              title="Riñones"
            />
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-sage-800 mb-4 flex items-center">
                    <Info className="w-5 h-5 mr-2" />
                    Productos Recomendados:
                  </h4>
                  <div className="space-y-6">
                    {bodyParts[selectedBodyPart].products.map((product, index) => (
                      <div key={index} className="border border-sage-200 rounded-lg p-4 bg-sage-50">
                        <h5 className="font-bold text-sage-800 text-lg mb-2">{product.name}</h5>
                        <div className="space-y-3">
                          <div>
                            <p className="font-semibold text-sage-700 mb-1">Propiedades:</p>
                            <p className="text-sage-600">{product.properties}</p>
                          </div>
                          <div>
                            <p className="font-semibold text-sage-700 mb-1">Recomendación:</p>
                            <p className="text-sage-600">{product.recommendation}</p>
                          </div>
                        </div>
                      </div>
                    ))}
